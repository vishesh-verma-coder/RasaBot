...
- hello there
- hello world
- hello, my name is [Vishesh Verma](name)
- hello?
- hello]
- hellooo
- helloooo
...
- hi friends
- hi hi
- hi i'm [Vishesh Verma](name)
- hi im [Vishesh Verma](name)
- hi pal!
- hi there
- hi there it's me
- hi!
...
- What is full form of [ESC](abb_esc)
- What [ESC](abb_esc) stands for?
- form of [ESC](abb_esc)
- full-form of [ESC](abb_esc)
- full form of [ESC](abb_esc)
- What does [ESC](abb_esc) stands for?
- What full form of [PDL](abb_pdl)
- What [PDL](abb_pdl) stands for?
- form of [PDL](abb_pdl) 
- full-form of [PDL](abb_pdl) 
- full form of [PDL](abb_pdl) 
- What is full form of [SLM](abb_slm)
- form of [SLM](abb_slm)
- full-form of [SLM](abb_slm)
- full form of [SLM](abb_slm)
- What [SLM](abb_slm) stands for?
- What does [SLM](abb_slm) stands for?
- What is full form of [SDN](abb_sdn)
- form of [SDN](abb_sdn)
- full-form of [SDN](abb_sdn)
- full form of [SDN](abb_sdn)
- What [SDN](abb_sdn) stands for?
- What is full form of [PPM](abb_ppm)
- form of [PPM](abb_ppm)
- full-form of [PPM](abb_ppm)
- full form of [PPM](abb_ppm)
- What [PPM](abb_ppm) stands for?
- What does [PPM](abb_ppm) stands for?
- What is full form of [UCC](abb_ucc)
- form of [UCC](abb_ucc)
- full-form of [UCC](abb_ucc)
- full form of [UCC](abb_ucc)
- What [UCC](abb_ucc) stands for?
- What does [UCC](abb_ucc) stands for?

## intent:ask_about_esc_domains_offerings_services
- What are services offered in [ESC](services_esc)
- What are domains in [ESC](services_esc)
- What services are provided in [ESC](services_esc)
- What activities are provided in [ESC](services_esc)
- What are offerings under [ESC](services_esc)
- What technology are supported in [ESC](services_esc)
- What services are supported in [ESC](services_esc)
- What activities are supported in [ESC](services_esc)
- What are services offered in [PDL](services_pdl)
- What are activities offered in [PDL](services_pdl)
- What are domains in [PDL](services_pdl)
- What services are provided in [PDL](services_pdl)
- What activities are provided in [PDL](services_pdl)
- What are offerings under [PDL](services_pdl)
- What services are supported in [PDL](services_pdl)
- What technology are supported in [PDL](services_pdl)
- What are services offered in [CyberSOC](services_cyber)
- What activities are offered in [CyberSOC](services_cyber)
- What are domains in [CyberSOC](services_cyber)
- What services are provided in [CyberSOC](services_cyber)
- What activities are provided in [CyberSOC](services_cyber)
- What are offerings under [CyberSOC](services_cyber)
- What services are supported in [CyberSOC](services_cyber)
- What technology are supported in [CyberSOC](services_cyber)
- What are services offered in [Netsec](services_netsec)
- What activities are offered in [Netsec](services_netsec)
- What are domains in [Netsec](services_netsec)
- What services are provided in [Netsec](services_netsec)
- What activities are provided in [Netsec](services_netsec)
- What are offerings under [Netsec](services_netsec)
- What services are supported in [Netsec](services_netsec)
- What technology are supported in [Netsec](services_netsec)
- What are services offered in [SDN](services_sdn)
- What activites are offered in [SDN](services_sdn)
- What are domains in [SDN](services_sdn)
- What services are provided in [SDN](services_sdn)
- What activities are provided in [SDN](services_sdn)
- What are offerings under [SDN](services_sdn)
- What services are supported in [SDN](services_sdn)
- What activities are supported in [SDN](services_sdn)
- What services are supported in [SD-WAN]{"entity":"services_sdn", "value":"SDN"}
- What technology are supported in [SDN](services_sdn)
- What services are supported in [SD-WAN]{"entity":"services_sdn", "value":"SDN"}
- What are services offered in [PPM](services_ppm)
- What are activities offered in [PPM](services_ppm)
- What are domains in [PPM](services_ppm)
- What services are provided in [PPM](services_ppm)
- What activities are provided in [PPM](services_ppm)
- What are offerings under [PPM](services_ppm)
- What services are supported in [PPM](services_ppm)
- What services are supported in [Program and Project Management]{"entity":"services_ppm", "value":"PPM"}
- What technology are supported in [PPM](services_ppm)
- What services are supported in [Program Management]{"entity":"services_ppm", "value":"PPM"}
- What are services offered in [Contact Center](services_contactcenter)
- What activities are offered in [Contact Center](services_contactcenter)
- What are domains in [Contact Center](services_contactcenter)
- What services are provided in [Contact Center](services_contactcenter)
- What activities are provided in [Contact Center](services_contactcenter)
- What are offerings under [CC]{"entity":"services_contactcenter", "value":"Contact Center"}
- What technology are supported in [Contact Center](services_contactcenter)
- What services are supported in [Contact Center](services_contactcenter)

## intent:ask_about_esc_manager
- Who is manager of [CyberSOC](department_cyber) 
- Who is heading [CyberSecurity](department_cyber)
...
- Which projects are running in ESC
- At present, which automation projects are going on in ESC
- Which projects related to automation are currently ongoing in ESC 

## intent:ask_about_esc_ongoing_training
- What are ongoing training in ESC?
- Which trainings are running in ESC
- At present, which trainings are going on in ESC
- Which trainings are currently ongoing in ESC

##intent:ask_about_esc_slm_activities
- main activities Service LifeCycle Manager ?
- main activities SLM
- main activities SLM
- role and responsibilities of SLM
- role and responsibilities of Service Lifecycle Manager
- responsibilities Service Lifecycle Manager
- role SLM

##intent:ask_about_esc_slm_objectives
- objectives Service LifeCycle Manager?
- main objectives SLM
- main objectives of SLM
- What are objectives Service LifeCycle Manager 
- What are objectives SLM

##intent:ask_about_esc_details_of_domains
- I want to know about [PDL](details_pdl)
- Can you tell me about [PDL](details_pdl) in detail
- What is [Product Development and Lifecyle]{"entity":"details_pdl", "value":"PDL"}
- Can you elaborate [PDL](details_pdl)
- elaborate [PDL](details_pdl)
- details of [PDL](details_pdl)
...
- Can you elaborate [PPM](details_ppm)
- elaborate [PPM](details_ppm)
- details of [PPM](details_ppm)
- Can you explain [PPM](details_ppm)
- explain [PPM](details_ppm)
- comprehensively explain [PPM](details_ppm)
- I want to know about [CyberSOC](details_cybersoc)
...
- explain [CyberSOC](details_cybersoc)
- comprehensively explain [CyberSOC](details_cybersoc)
- I want to know about [NetSec](details_netsec)
...
- details of [SDN](details_sdn)
- Can you explain [SDN](details_sdn)
- explain [SDN](details_sdn)
- comprehensively explain [SDN](details_sdn)
- Can you elaborate [ESC](details_esc)
- elaborate [ESC](details_esc)
- details of [ESC](details_esc)
- Can you explain [ESC](details_esc)
- explain [ESC](details_esc)
- comprehensively explain [ESC](details_esc)

##intent:ask_about_esc_shift_times
- How many different shifts are there
- different shifts
- shift timings
- shift types
- office time
...
##intent:ask_about_esc_plazza_and_esc_portalpage
- ESC Plazza
- Plazza
- Plazza page
- Plazza URL
- discussion platform
- internal page plazza
- ESC Portal
- ESC internal page
- web address ESC
- link of ESC portal
